...
resource "cloudflare_r2_bucket" "production_public" {
  account_id = var.cloudflare_account_id
  name       = "production-revendiste-public"
...
resource "cloudflare_r2_bucket" "production_private" {
  account_id = var.cloudflare_account_id
  name       = "production-revendiste-private"
  location   = var.r2_bucket_location
...
resource "cloudflare_r2_custom_domain" "production_cdn" {
  account_id  = var.cloudflare_account_id
  bucket_name = cloudflare_r2_bucket.production_public.name
