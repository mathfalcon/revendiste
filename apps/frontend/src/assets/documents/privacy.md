...
El usuario puede revocar el acceso de Revendiste a su cuenta de Google en cualquier momento desde la configuración de seguridad de su cuenta de Google: [https://myaccount.google.com/permissions](https://myaccount.google.com/permissions)

### 6.5 Política de Google

El uso de la autenticación mediante Google se encuentra sujeto, además, a la [Política de Privacidad de Google](https://policies.google.com/privacy) y sus [Términos de Servicio](https://policies.google.com/terms).
