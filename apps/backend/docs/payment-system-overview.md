...
The payment system is built with a **provider pattern** architecture, allowing support for multiple payment providers (dLocal, Stripe, MercadoPago, etc.) through a unified interface.
...
| `provider`            | enum        | dlocal, stripe, mercadopago                         |
