...
const models: TsoaRoute.Models = {
    ...
    "GetPayoutDetailsResponse": {
        "dataType": "refAlias",
        "type": {"dataType":"nestedObjectLiteral","nestedProperties":{"linkedEarnings":{"dataType":"array","array":{"dataType":"nestedObjectLiteral","nestedProperties":{"venueName":{"dataType":"union","subSchemas":[{"dataType":"string"},{"dataType":"enum","enums":[null]}],"required":true},"ticketWaveName":{"dataType":"string","required":true},"eventEndDate":{"dataType":"string","required":true},"eventStartDate":{"dataType":"string","required":true},"eventSlug":{"dataType":"string","required":true},"eventName":{"dataType":"string","required":true},"sellerAmount":{"dataType":"string","required":true},"listingTicketId":{"dataType":"string","required":true},"currency":{"ref":"EventTicketCurrency","required":true},"id":{"dataType":"string","required":true},"createdAt":{"dataType":"string","required":true},"listingId":{"dataType":"string","required":true}}},"required":true},"transactionReference":{"dataType":"union","subSchemas":[{"dataType":"string"},{"dataType":"enum","enums":[null]}],"required":true},"requestedAt":{"dataType":"datetime","required":true},"processingFee":{"dataType":"union","subSchemas":[{"dataType":"string"},{"dataType":"enum","enums":[null]}],"required":true},"processedBy":{"dataType":"union","subSchemas":[{"dataType":"string"},{"dataType":"enum","enums":[null]}],"required":true},"processedAt":{"dataType":"union","subSchemas":[{"dataType":"datetime"},{"dataType":"enum","enums":[null]}],"required":true},"payoutProvider":{"dataType":"union","subSchemas":[{"dataType":"enum","enums":["dlocal_go"]},{"dataType":"enum","enums":["manual_bank"]}],"required":true},"payoutMethodId":{"dataType":"string","required":true},"notes":{"dataType":"union","subSchemas":[{"dataType":"string"},{"dataType":"enum","enums":[null]}],"required":true},"failureReason":{"dataType":"union","subSchemas":[{"dataType":"string"},{"dataType":"enum","enums":[null]}],"required":true},"failedAt":{"dataType":"union","subSchemas":[{"dataType":"datetime"},{"dataType":"enum","enums":[null]}],"required":true},"amount":{"dataType":"string","required":true},"completedAt":{"dataType":"union","subSchemas":[{"dataType":"datetime"},{"dataType":"enum","enums":[null]}],"required":true},"sellerUserId":{"dataType":"string","required":true},"currency":{"ref":"EventTicketCurrency","required":true},"updatedAt":{"dataType":"datetime","required":true},"status":{"dataType":"union","subSchemas":[{"dataType":"enum","enums":["cancelled"]},{"dataType":"enum","enums":["pending"]},{"dataType":"enum","enums":["completed"]},{"dataType":"enum","enums":["failed"]},{"dataType":"enum","enums":["processing"]}],"required":true},"id":{"dataType":"string","required":true},"createdAt":{"dataType":"datetime","required":true},"payoutMethod":{"dataType":"union","subSchemas":[{"dataType":"nestedObjectLiteral","nestedProperties":{"metadata":{"dataType":"union","subSchemas":[{"dataType":"string"},{"dataType":"double"},{"dataType":"boolean"},{"ref":"JsonArray"},{"ref":"JsonObject"},{"dataType":"enum","enums":[null]}],"required":true},"currency":{"ref":"EventTicketCurrency","required":true},"accountHolderSurname":{"dataType":"string","required":true},"accountHolderName":{"dataType":"string","required":true},"payoutType":{"ref":"PayoutType","required":true},"id":{"dataType":"string","required":true}}},{"dataType":"enum","enums":[null]}],"required":true},"seller":{"dataType":"union","subSchemas":[{"dataType":"nestedObjectLiteral","nestedProperties":{"email":{"dataType":"string","required":true},"lastName":{"dataType":"union","subSchemas":[{"dataType":"string"},{"dataType":"enum","enums":[null]}],"required":true},"firstName":{"dataType":"union","subSchemas":[{"dataType":"string"},{"dataType":"enum","enums":[null]}],"required":true},"id":{"dataType":"string","required":true}}},{"dataType":"enum","enums":[null]}],"required":true},"fxDecisionSupport":{"dataType":"nestedObjectLiteral","nestedProperties":{"dLocalAverageExchangeRate":{"dataType":"union","subSchemas":[{"dataType":"double"},{"dataType":"enum","enums":[null]}],"required":true},"uyuCostAtLockedRate":{"dataType":"union","subSchemas":[{"dataType":"double"},{"dataType":"enum","enums":[null]}],"required":true},"rateLockMsRemaining":{"dataType":"union","subSchemas":[{"dataType":"double"},{"dataType":"enum","enums":[null]}],"required":true},"rateLockExpired":{"dataType":"boolean","required":true},"fxProcessing":{"dataType":"union","subSchemas":[{"dataType":"nestedObjectLiteral","nestedProperties":{"rateWasExpired":{"dataType":"union","subSchemas":[{"dataType":"boolean"},{"dataType":"undefined"}]},"processedAt":{"dataType":"union","subSchemas":[{"dataType":"string"},{"dataType":"undefined"}]},"actualUyuCost":{"dataType":"union","subSchemas":[{"dataType":"double"},{"dataType":"undefined"}]},"actualBankRate":{"dataType":"union","subSchemas":[{"dataType":"double"},{"dataType":"undefined"}]}}},{"dataType":"enum","enums":[null]}],"required":true},"rateLock":{"dataType":"union","subSchemas":[{"dataType":"nestedObjectLiteral","nestedProperties":{"convertedCurrency":{"dataType":"string","required":true},"convertedAmount":{"dataType":"double","required":true},"originalCurrency":{"dataType":"string","required":true},"originalAmount":{"dataType":"double","required":true},"rateExpiresAt":{"dataType":"string","required":true},"lockedAt":{"dataType":"string","required":true},"spreadPercent":{"dataType":"double","required":true},"brouVentaRate":{"dataType":"double","required":true},"lockedRate":{"dataType":"double","required":true}}},{"dataType":"undefined"}],"required":true},"rateLockHoursConfigured":{"dataType":"double","required":true},"spreadPercentConfigured":{"dataType":"double","required":true},"currentBrouVentaRate":{"dataType":"union","subSchemas":[{"dataType":"double"},{"dataType":"enum","enums":[null]}],"required":true}},"required":true},"settlementInfo":{"dataType":"union","subSchemas":[{"dataType":"nestedObjectLiteral","nestedProperties":{"linkedProcessorSettlements":{"dataType":"array","array":{"dataType":"nestedObjectLiteral","nestedProperties":{"paymentProvider":{"dataType":"string","required":true},"settlementCurrency":{"dataType":"string","required":true},"totalAmount":{"dataType":"string","required":true},"settlementStatus":{"dataType":"string","required":true},"settlementDate":{"dataType":"datetime","required":true},"externalSettlementId":{"dataType":"string","required":true},"id":{"dataType":"string","required":true}}},"required":true},"providers":{"dataType":"array","array":{"dataType":"string"},"required":true},"hasExchangeRateData":{"dataType":"boolean","required":true},"settlements":{"dataType":"array","array":{"dataType":"nestedObjectLiteral","nestedProperties":{"providers":{"dataType":"array","array":{"dataType":"string"},"required":true},"paymentCount":{"dataType":"double","required":true},"balanceCurrency":{"dataType":"union","subSchemas":[{"dataType":"string"},{"dataType":"enum","enums":[null]}],"required":true},"averageExchangeRate":{"dataType":"union","subSchemas":[{"dataType":"double"},{"dataType":"enum","enums":[null]}],"required":true},"totalSellerAmount":{"dataType":"double","required":true},"totalBalanceFee":{"dataType":"double","required":true},"totalBalanceAmount":{"dataType":"double","required":true},"totalPaymentAmount":{"dataType":"double","required":true},"currency":{"dataType":"string","required":true}}},"required":true}}},{"dataType":"enum","enums":[null]}],"required":true},"documents":{"dataType":"array","array":{"dataType":"nestedObjectLiteral","nestedProperties":{"uploadedBy":{"dataType":"string","required":true},"uploadedAt":{"dataType":"datetime","required":true},"storagePath":{"dataType":"string","required":true},"sizeBytes":{"dataType":"double","required":true},"payoutId":{"dataType":"string","required":true},"originalName":{"dataType":"string","required":true},"mimeType":{"dataType":"string","required":true},"fileName":{"dataType":"string","required":true},"documentType":{"dataType":"string","required":true},"updatedAt":{"dataType":"datetime","required":true},"id":{"dataType":"string","required":true},"deletedAt":{"dataType":"union","subSchemas":[{"dataType":"datetime"},{"dataType":"enum","enums":[null]}],"required":true},"createdAt":{"dataType":"datetime","required":true},"url":{"dataType":"string","required":true}}},"required":true},"metadata":{"dataType":"union","subSchemas":[{"dataType":"nestedObjectLiteral","nestedProperties":{"fxProcessing":{"dataType":"union","subSchemas":[{"dataType":"nestedObjectLiteral","nestedProperties":{"rateWasExpired":{"dataType":"union","subSchemas":[{"dataType":"boolean"},{"dataType":"undefined"}]},"processedAt":{"dataType":"union","subSchemas":[{"dataType":"string"},{"dataType":"undefined"}]},"actualUyuCost":{"dataType":"union","subSchemas":[{"dataType":"double"},{"dataType":"undefined"}]},"actualBankRate":{"dataType":"union","subSchemas":[{"dataType":"double"},{"dataType":"undefined"}]}}},{"dataType":"undefined"}]},"dLocalArRateLock":{"dataType":"union","subSchemas":[{"dataType":"nestedObjectLiteral","nestedProperties":{"rateArsPerUsd":{"dataType":"double","required":true},"destinationAmountArs":{"dataType":"double","required":true},"sourceAmountUsd":{"dataType":"double","required":true},"rateExpiresAt":{"dataType":"string","required":true},"lockedAt":{"dataType":"string","required":true},"quoteId":{"dataType":"string","required":true}}},{"dataType":"undefined"}]},"rateLock":{"dataType":"union","subSchemas":[{"dataType":"nestedObjectLiteral","nestedProperties":{"convertedCurrency":{"dataType":"string","required":true},"convertedAmount":{"dataType":"double","required":true},"originalCurrency":{"dataType":"string","required":true},"originalAmount":{"dataType":"double","required":true},"rateExpiresAt":{"dataType":"string","required":true},"lockedAt":{"dataType":"string","required":true},"spreadPercent":{"dataType":"double","required":true},"brouVentaRate":{"dataType":"double","required":true},"lockedRate":{"dataType":"double","required":true}}},{"dataType":"undefined"}]},"listingIds":{"dataType":"array","array":{"dataType":"string"},"required":true},"listingTicketIds":{"dataType":"array","array":{"dataType":"string"},"required":true}},"additionalProperties":{"dataType":"any"}},{"dataType":"enum","enums":[null]}],"required":true}},"validators":{}},
    },
    // WARNING: This file was auto-generated with @mathfalcon/tsoa. Please do not modify it. Re-run @mathfalcon/tsoa to re-generate this file: https://github.com/lukeautry/tsoa
...
export function RegisterRoutes(app: Router,opts?:{multer?:ReturnType<typeof multer>}) {
    ...
    const upload = opts?.multer ||  multer({"limits":{"fileSize":8388608}});
        ...
        // WARNING: This file was auto-generated with @mathfalcon/tsoa. Please do not modify it. Re-run @mathfalcon/tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        const argsAdminPayoutsController_refreshPayoutRateLock: Record<string, TsoaRoute.ParameterSchema> = {
                payoutId: {"in":"path","name":"payoutId","required":true,"dataType":"string"},
                _body: {"in":"body","name":"_body","required":true,"ref":"RefreshPayoutRateLockRouteBody"},
                request: {"in":"request","name":"request","required":true,"dataType":"object"},
        };
        app.post('/admin/payouts/:payoutId/refresh-rate-lock',
            ...(fetchMiddlewares<RequestHandler>(AdminPayoutsController)),
            ...(fetchMiddlewares<RequestHandler>(AdminPayoutsController.prototype.refreshPayoutRateLock)),

            async function AdminPayoutsController_refreshPayoutRateLock(request: ExRequest, response: ExResponse, next: any) {

            // WARNING: This file was auto-generated with @mathfalcon/tsoa. Please do not modify it. Re-run @mathfalcon/tsoa to re-generate this file: https://github.com/lukeautry/tsoa

            let validatedArgs: any[] = [];
            try {
                validatedArgs = templateService.getValidatedArgs({ args: argsAdminPayoutsController_refreshPayoutRateLock, request, response });

                const controller = new AdminPayoutsController();

              await templateService.apiHandler({
                methodName: 'refreshPayoutRateLock',
                controller,
                response,
                next,
                validatedArgs,
