...
const models: TsoaRoute.Models = {
    ...
    "GetPayPalUyuFxPreviewResponse": {
        "dataType": "refAlias",
        "type": {"dataType":"nestedObjectLiteral","nestedProperties":{"rateLockHours":{"dataType":"double","required":true},"effectiveUyuPerUsd":{"dataType":"double","required":true},"spreadPercent":{"dataType":"double","required":true},"referenceVentaUyuPerUsd":{"dataType":"double","required":true}},"validators":{}},
    },
    // WARNING: This file was auto-generated with @mathfalcon/tsoa. Please do not modify it. Re-run @mathfalcon/tsoa to re-generate this file: https://github.com/lukeautry/tsoa
...
export function RegisterRoutes(app: Router,opts?:{multer?:ReturnType<typeof multer>}) {
    ...
    const upload = opts?.multer ||  multer({"limits":{"fileSize":8388608}});
        ...
        // WARNING: This file was auto-generated with @mathfalcon/tsoa. Please do not modify it. Re-run @mathfalcon/tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        const argsPayoutsController_getPayPalUyuFxPreview: Record<string, TsoaRoute.ParameterSchema> = {
        };
        app.get('/payouts/paypal-uyu-fx-preview',
            ...(fetchMiddlewares<RequestHandler>(PayoutsController)),
            ...(fetchMiddlewares<RequestHandler>(PayoutsController.prototype.getPayPalUyuFxPreview)),

            async function PayoutsController_getPayPalUyuFxPreview(request: ExRequest, response: ExResponse, next: any) {

            // WARNING: This file was auto-generated with @mathfalcon/tsoa. Please do not modify it. Re-run @mathfalcon/tsoa to re-generate this file: https://github.com/lukeautry/tsoa

            let validatedArgs: any[] = [];
            try {
                validatedArgs = templateService.getValidatedArgs({ args: argsPayoutsController_getPayPalUyuFxPreview, request, response });

                const controller = new PayoutsController();

              await templateService.apiHandler({
                methodName: 'getPayPalUyuFxPreview',
                controller,
                response,
                next,
                validatedArgs,
